...
export function NoteCard(props: NoteCardProps) {
    return (
        <Dialog.Root>
            <Dialog.Trigger className='rounded-md text-left flex flex-col bg-slate-800 p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-400 focus-visible:ring-2 outline-none focus-visible:ring-lime-400'>
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed flex flex-col overflow-hidden left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 max-w-[640px] w-full h-[60vh] bg-slate-700 rounded-md outline-none'>
                    ...
                    <button
                        type="button"
                        className='w-full bg-slate-800 py-4 text-center text-sm text-slate-300 outline-none font-medium group items-end'
                    >
